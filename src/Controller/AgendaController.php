...
{
    /**
     * @Route("/admin/agenda", name="agenda_index", methods={"GET"})
     */
    //#[Route('/admin/agenda', name: 'agenda_index', methods: ['GET'])]
    ...
    /**
     * @Route("/admin/agenda/new", name="agenda_new", methods={"GET", "POST"})
     */
    //#[Route('/admin/agenda/new', name: 'agenda_new', methods: ['GET', 'POST'])]
    ...
    /**
     * @Route("/admin/agenda/{id}", name="agenda_show", methods={"GET"})
     */
    //#[Route('/admin/agenda/{id}', name: 'agenda_show', methods: ['GET'])]
    ...
    /**
     * @Route("/admin/agenda/{id}/edit", name="agenda_edit", methods={"GET", "POST"})
     */
    //#[Route('/admin/agenda/{id}/edit', name: 'agenda_edit', methods: ['GET', 'POST'])]
    ...
    /**
     * @Route("/admin/agenda/{id}", name="agenda_delete", methods={"POST"})
     */
    //#[Route('/admin/agenda/{id}', name: 'agenda_delete', methods: ['POST'])]
